...
export function HelpIcon({ className = defaultClass }: IconProps) {
  return (
    <svg {...baseProps} className={className} data-testid="nav-icon-help">
...
export function SunIcon({ className = defaultClass }: IconProps) {
  return (
    <svg {...baseProps} className={className} data-testid="nav-icon-sun">
...
export function MoonIcon({ className = defaultClass }: IconProps) {
  return (
    <svg {...baseProps} className={className} data-testid="nav-icon-moon">
