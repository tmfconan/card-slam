      ...
      <div className="mb-4 flex flex-wrap items-center gap-4">
        ...
        <div className="flex rounded-lg border dark:border-gray-700 overflow-hidden text-sm">
          ...
          <button
            ...
            className="px-3 py-1.5 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800"
          >
            Day
          </button>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border dark:border-gray-700 rounded-lg px-2 py-1 dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-500 focus:outline-none"
          >
