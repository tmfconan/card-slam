      ...
      <div className="mb-4 flex flex-wrap items-center gap-4">
        ...
        <div className="flex rounded-lg border dark:border-gray-700 overflow-hidden text-sm">
          ...
          <button
            ...
            className="px-3 py-1.5 transition-colors bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800"
          >
            Day
          </button>
        </div>
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="px-2 py-1 text-sm border dark:border-gray-700 rounded bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800"
          >
            ← Prev
          </button>
          <button
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border dark:border-gray-700 rounded-lg px-2 py-1 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 focus:outline-none"
          >
